...
export const OrganisationAccountLinkConfirmationTemplate = ({
  ...
  const previewText =
    type === 'create'
      ...
      : msg`A request has been made to link your NorthSign account`;
            ...
            <Section className="p-2 text-muted-foreground">
              <Text className="text-center font-medium text-foreground text-lg">
                {type === 'create' ? (
                  ...
                  <Trans>Link your NorthSign account</Trans>
                )}
              </Text>
              ...
              <Text className="text-center text-base">
                {type === 'create' ? (
                  ...
                  <Trans>
                    <span className="font-bold">{organisationName}</span> has requested to link your current NorthSign
              ...
              {/* <Section className="mt-6">
                ...
                <Text className="mt-2 text-sm">
                  <Trans>
                    You can unlink your account at any time in your security settings on NorthSign{' '}
