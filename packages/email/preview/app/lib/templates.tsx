...
export const templates: Record<string, TemplateDefinition> = {
  ...
  'document-invite': {
    ...
    fields: {
      ...
      inviterEmail: { type: 'text', label: 'Inviter email', default: 'lucas@northsign.ca' },
  ...
  'document-rejected': {
    ...
    fields: {
      recipientName: recipientNameField,
      documentName: documentNameField,
      documentUrl: { type: 'text', label: 'Document URL', default: 'https://northsign.ca' },
      rejectionReason: {
        type: 'textarea',
  ...
  'organisation-invite': {
    ...
    fields: {
      ...
      organisationName: { type: 'text', label: 'Organisation name', default: 'NorthSign' },
    },
  },
  'organisation-join': {
  ...
  'confirm-team-email': {
    ...
    fields: {
      teamName: { type: 'text', label: 'Team name', default: 'NorthSign' },
    },
  },
  'team-delete': {
    name: 'Team delete',
  ...
  'team-email-removed': {
    ...
    fields: {
      teamName: { type: 'text', label: 'Team name', default: 'NorthSign' },
      teamEmail: { type: 'text', label: 'Team email', default: 'team@northsign.ca' },
    },
  },
  ...
  'confirm-email': {
    ...
    fields: {
      confirmationLink: {
        ...
        default: 'https://northsign.ca/confirm',
      },
    },
  },
  'forgot-password': {
    ...
    fields: {
      resetPasswordLink: {
        type: 'text',
        label: 'Reset link',
        default: 'https://northsign.ca/reset',
      },
    },
  },
  'reset-password': {
    ...
    fields: {
      userName: { type: 'text', label: 'User name', default: 'Lucas Smith' },
      userEmail: { type: 'text', label: 'User email', default: 'lucas@northsign.ca' },
    },
  },
  'access-auth-2fa': {
