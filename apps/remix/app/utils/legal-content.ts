  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        'Document participants (recipients, who usually do not have an account): email address and name, provided by the document sender so we can deliver the signing invitation; your signature (typed, drawn, or uploaded) and any field values (dates, text, choices) you enter; an email-language preference the sender may set for you so your signing emails arrive in your language (you can ask the sender to change or clear it); and the technical evidence of your interaction — timestamps, open/signed status, and, for document events, your IP address and browser user-agent. This evidence forms the audit trail (piste d’audit) that makes an electronic signature verifiable; it is disclosed to you on the signing certificate and it is the core purpose of the service. If you do not want your interaction recorded, do not sign electronically.',
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        'Participants à un document (destinataires, qui n’ont généralement pas de compte) : adresse courriel et nom, fournis par l’expéditeur du document pour livrer l’invitation à signer; votre signature (tapée, tracée ou téléversée) et les valeurs de champs que vous saisissez (dates, textes, choix); une préférence de langue des courriels que l’expéditeur peut définir pour vous afin que vos courriels de signature arrivent dans votre langue (vous pouvez demander à l’expéditeur de la modifier ou de l’effacer); ainsi que les preuves techniques de votre interaction — horodatages, statut d’ouverture et de signature et, pour les événements liés au document, votre adresse IP et votre agent utilisateur. Ces preuves forment la piste d’audit qui rend une signature électronique vérifiable; elles vous sont divulguées sur le certificat de signature et constituent la finalité même du service. Si vous ne souhaitez pas que votre interaction soit consignée, ne signez pas électroniquement.',
